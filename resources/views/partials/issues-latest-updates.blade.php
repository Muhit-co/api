						...
						<small>
							<div class="u-mb5">
								<div class="u-floatright u-opacity75 hasTooltip">
                                    ...
                                    <div id="relativeTimeTooltip_{{$key}}" name="relativeTimeTooltip" class="tooltip tooltip-compact tooltip-alignright" style="width: auto; white-space: nowrap;" date="{{$issue->updated_at}}">
										{{$issue->updated_at}}                                    </div>
								</div>
								FİKİR GÜNCELLENDİ
							</div>
							<h4>{{ $issue->title }}</h4>
