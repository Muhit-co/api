<?php
$height = (isset($height)) ? $height : '36px';
$colour = (isset($colour)) ? $colour : 'white';
?>

<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 599.5 130.9" style="enable-background:new 0 0 599.5 130.9;" xml:space="preserve" height="{{ $height }}" class="logo-svg logo-svg-{{ $colour }}">
<style type="text/css">
  .st0{fill:#44a1e0;}
</style>
<g id="logo">
