    ...
    <form method="post" action="{{$url}}">
        ...
        <div class="dialog-content">
            ...
            <div class="form-group form-fullwidth">
                <textarea class="form-input form-grey" value="" name="comment" rows="4"
                          placeholder="{{ trans('issues.placeholder_your_message') }}" required></textarea>
            </div>
        </div>
