    ...
    <form method="post" action="">
        ...
        <div class="dialog-content">
            <div class="badge badge-circle badge-circle-large u-floatleft u-mr20 u-ph10 u-pv20 col-sm-hide">
                <i class="ion ion-checkmark-circled ion-2x c-light"></i>
            </div>
            <h2 class="u-mr30">
                {{ trans('issues.change_status_solved') }}
            </h2>
            <p class="u-mt20">{{ trans('issues.change_status_solved_descr') }}</p>
        </div>
        ...
        <div class="u-alignright">
            ...
            <button type="submit" class="btn btn-solved">{{ trans('issues.in_progress_cap') }}</button>
        </div>
