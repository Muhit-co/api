                ...
                <div class="u-floatright">
                    ...
                    <form method="get">
                        ...
                        <div class="form-group u-floatleft u-width150">
                            <input class="form-input" name="q" type="text" placeholder="Search..." value="{{ $param_q }}" />
                            @if (strlen($param_q) > 0)
                                <a href="{{ '?' . buildRelativeUrl('q', '') }}" class="form-appendRight u-ph15" style="padding-top: 8px;"><i class="ion ion-close"></i></a>
                            @endif
                        </div>
                ...
                <div class="list-header u-pr110 u-relative">
                    ...
                    <div class="u-pinned-topright u-ma10">
                        <small class="c-medium">
                            {{count($members)}} record{{ count($members) != 1 ? 's' : '' }}
                        </small>
                    </div>
                </div>
                            ...
                            <a href="/admin/view-member/{{$m->id}}" class="u-pr110">
                                <div class="row row-nopadding">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="u-nowrap u-pt5 c-bluedark">
                                            <small class="u-nowrap">{{$m->first_name}} {{$m->last_name}}</small>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-sm-hide">
