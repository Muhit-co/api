...
@section('title')
    ...
    {{ trans('email.created_idea_commented_title', array('sender' => '[X Muhtarı/ Y Belediyesi]')) }}
...
@section('content')
    ...
    {{ trans('email.created_idea_commented_content', array('sender' => '[X Muhtarı/ Y Belediyesi]')) }}
