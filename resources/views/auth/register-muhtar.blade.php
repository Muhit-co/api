            ...
            <form method="post" action="/register">
                ...
                <div class="form-group form-fullwidth u-mb10">
                    <div class="row row-nopadding">
                        <div class="col-xs-6">
                            <input id="type_muhtar" type="radio" checked="checked" class="form-input" value="muhtar" name="admin_type" />
                            <label for="type_muhtar">{{ trans('auth.muhtar') }}</label>
                        </div>
                        <div class="col-xs-6">
                            <input id="type_municipality" type="radio" class="form-input" value="municipality" name="admin_type" />
